...
export default function AboutHero() {
  return (
    <section className="relative pt-36 pb-24 lg:pt-44 lg:pb-32 overflow-hidden bg-[#050507]">
      ...
      <div className="w-[92%] max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-14 items-center relative z-10">
        ...
        <div>
          ...
          <motion.div
            ...
            className="mb-6 inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-xs tracking-widest text-white/60 uppercase"
          >
          ...
          <motion.h1
            ...
            className="text-[2.4rem] md:text-[3.5rem] lg:text-[4.2rem] font-bold leading-[1.15] tracking-tight mb-8"
          >
          ...
          >
            {["900+ किसान सदस्य", "1200+ परिवार", "₹3Cr+ ऋण", "70+ वर्ष सेवा"].map((t, i) => (
              <div
                key={i}
                className="px-5 py-2 rounded-full bg-white/5 border border-white/10 text-sm text-white/70 backdrop-blur-sm"
              >
                {t}
              </div>
            ))}
        ...
        >
          <div className="relative rounded-[2.5rem] overflow-hidden border border-white/10 shadow-[0_40px_120px_rgba(0,0,0,0.8)]">
            ...
            {/* floating badge */}
            <div className="absolute bottom-6 left-6 px-5 py-3 rounded-xl bg-black/50 backdrop-blur-md border border-white/10">
              <div className="text-white font-bold text-lg">स्थापना</div>
              <div className="text-premium-emerald font-bold text-2xl">1954</div>
            </div>
