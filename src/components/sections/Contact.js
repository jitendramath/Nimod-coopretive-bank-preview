...
export default function Contact() {
  return (
    <section id="contact" className="py-24 bg-premium-slate relative overflow-hidden">
      ...
      {/* REAL FIX: भारी blur-[120px] वाले ग्लो को हटा दिया गया है। 
          अब बैकग्राउंड एकदम साफ़ और लैग-फ्री रहेगा */}
      ...
      <div className="w-[92%] max-w-[1200px] mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="relative">
            <form className="p-8 md:p-10 rounded-3xl bg-premium-charcoal border border-white/10 shadow-2xl relative z-10">
              <div className="space-y-6">
