        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="relative">
            <form 
              ...
              className="p-8 md:p-10 rounded-3xl bg-gradient-to-b from-[#0b0c11] to-[#050507] border border-white/10 shadow-[0_40px_120px_rgba(0,0,0,0.8)] relative z-10"
            >
              <div className="space-y-6">
                ...
                <button 
                  type="submit"
                  className="w-full py-4 rounded-xl bg-premium-emerald text-premium-black font-bold text-lg hover:scale-[1.02] transition-all"
                >
                  संदेश भेजें
                </button>
